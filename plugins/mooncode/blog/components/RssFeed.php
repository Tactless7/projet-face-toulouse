...
class RssFeed extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'mooncode.blog::lang.settings.rssfeed_title',
            'description' => 'mooncode.blog::lang.settings.rssfeed_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'blogPage' => [
                'title'       => 'mooncode.blog::lang.settings.rssfeed_blog',
                'description' => 'mooncode.blog::lang.settings.rssfeed_blog_description',
                'type'        => 'dropdown',
                'default'     => 'blog/post',
                'group'       => 'Links',
            ],
