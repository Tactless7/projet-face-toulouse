...
class Category extends Model
{
    ...
    public $table = 'mooncode_blog_categories';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:mooncode_blog_categories',
        'code' => 'unique:mooncode_blog_categories',
    ];
    ...
    public $belongsToMany = [
        'posts' => ['Mooncode\Blog\Models\Post',
