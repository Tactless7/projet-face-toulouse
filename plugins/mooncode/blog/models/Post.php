<?php namespace Mooncode\Blog\Models;
...
class Post extends Model
{
    ...
    public $table = 'mooncode_blog_posts';
    public $implement = ['@Mooncode.Translate.Behaviors.TranslatableModel'];
    ...
    public $rules = [
        'title' => 'required',
        'slug' => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:mooncode_blog_posts'],
        'content' => 'required',
        'excerpt' => ''
    ];
    ...
    public $belongsToMany = [
        'categories' => [
            'Mooncode\Blog\Models\Category',
            'table' => 'mooncode_blog_posts_categories',
            'order' => 'name'
        ]
    ];
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(['mooncode.blog.access_publish'])) {
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('mooncode.blog::lang.post.published_validation')
            ]);
        }
    }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['mooncode.blog.access_other_posts']);
    }
     ...
     * @param \Mooncode\Pages\Classes\MenuItem $item Specifies the menu item.
